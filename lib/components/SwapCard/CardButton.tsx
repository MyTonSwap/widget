...
const CardButton: FC<CardButtonProps & PropsWithChildren> = ({
    ...
    return (
        <button
            ...
            className={cn(
                'mts-flex mts-gap-1 mts-items-center mts-transition-all mts-ease-in-out mts-rounded-full mts-py-1 mts-pr-2 mts-pl-1 mts-h-10 mts-font-semibold mts-text-sm mts-ltr mts-text-black mts-border-[1px]',
