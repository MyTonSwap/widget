...
const TokensSettings = () => {
    ...
    return (
        <div className="mts-flex mts-justify-between mts-items-center mts-px-1 mts-text-xs md:mts-text-sm">
            <div className="mts-text-zinc-600 mts-text-lg dark:mts-text-zinc-200">
                <span>{t('community_tokens')}</span>
            </div>
            <div>
                <button
                    className={cn(
                        'mts-flex mts-relative mts-justify-start mts-items-center mts-transition-all mts-duration-300 mts-rounded-full mts-bg-zinc-100 mts-p-1 mts-w-12 mts-h-6 mts-shadow-[0px_0px_0px_4px_rgb(var(--mts-primary-100))] dark:mts-bg-zinc-900 dark:mts-shadow-[0px_0px_0px_4px_rgb(var(--mts-primary-800))]',
                ...
                >
                    <div
                        className={cn(
                            ...
                            communityTokens
                                ? 'mts-left-7 mts-bg-white dark:mts-bg-zinc-800'
